...
def veritabanini_yukle():
    with open('C:\\Users\\Ömer KIYAK\\Desktop\\chatbot\\genai\\karıştır\\veri.json', 'r') as dosya:
        return json.load(dosya)

def veritabanina_yaz(veriler):
    with open('C:\\Users\\Ömer KIYAK\\Desktop\\chatbot\\genai\\karıştır\\veri.json', 'w') as dosya:
